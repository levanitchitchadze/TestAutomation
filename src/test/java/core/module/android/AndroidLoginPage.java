...
@Getter
@Slf4j
public class AndroidLoginPage extends AppiumHelper implements HasWrongAttemptWindow, LoginPage {
...
//            waitFor(SUBMIT_BTN);
            ...
            throw new RuntimeException("Can't find login elements with username input:" + USERNAME_INPUT + " and password input:" + PASSWORD_INPUT + "\nError:" + nfe);
//            return false;
        }
